...
/**
 * Implementação da interface {@link Register} para o registro C001 do EFD ICMS IPI.
 * Este registro representa um registro específico dentro do bloco C.
 */
public class RegisterC001 implements Register {
    ...
    /**
     * Construtor da classe {@code RegisterC001}.
     *
