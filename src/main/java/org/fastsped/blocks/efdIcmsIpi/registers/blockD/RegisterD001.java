...
/**
 * Implementação da interface {@link Register} para o registro D001 do EFD ICMS IPI.
 * Este registro representa um bloco de dados específico dentro do bloco D.
 */
public class RegisterD001 implements Register {
    ...
    /**
     * Construtor da classe {@code RegisterD001}.
     *
