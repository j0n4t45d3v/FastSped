package org.fastsped.efdIcmsIpi.registers.blockC;
...
public class RegisterC170 implements Register {
    ...
    public String generateRegister() {
        return BuilderRegister.builder("C170")
                ...
                .add(EFDFormatter.cstIcms(this.invoiceItem.getCstIcms())).add(this.invoiceItem.getCfop())
                .add(this.invoiceItem.getCodNat()).add(EFDFormatter.bigDecimal(this.invoiceItem.getVlBcIcms()))
